...
export async function migrate(database: Database) {
  const migrations = await Promise.all(["001_typescript", "002_group_cache", "003_sending_window", "004_admin_billing_support", "005_user_language", "006_template_settings", "007_admin_browser_broadcasts", "008_photo_message_sources"].map(async version =>
