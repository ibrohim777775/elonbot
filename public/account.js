...
const messages = {
  ...
  description: ["E'lonlar tanlagan guruhlaringizga o'z akkauntingizdan yuboriladi. Bot bilan yozishayotgan akkauntingizga kiring.", "Объявления будут отправляться в выбранные группы от вашего имени. Войдите в тот аккаунт, с которого вы общаетесь с ботом."],
  note: ["Ulangan sessiya shifrlangan holda saqlanadi. Kod va 2FA paroli saqlanmaydi. Botdagi «Sozlamalar» → «Telegram akkaunt» bo'limidan uzishingiz mumkin.", "Сессия хранится в зашифрованном виде. Код и пароль 2FA не сохраняются. Отключить аккаунт можно в разделе «Настройки» → «Telegram-аккаунт» в боте."],
